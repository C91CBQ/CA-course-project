...
class INSMem
{
      public:
          ...
          bitset<32> ReadMemory (bitset<32> ReadAddress) 
              {    
		bitset<32> Instruction=std::bitset<32>(IMem[ReadAddress.to_ulong()].to_string()+IMem[ReadAddress.to_ulong()+1].to_string()+IMem[ReadAddress.to_ulong()+2].to_string()+IMem[ReadAddress.to_ulong()+3].to_string());
